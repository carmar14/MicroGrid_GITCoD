...
#ifndef RTW_HEADER_modelo_BIO_h_
#define RTW_HEADER_modelo_BIO_h_
#include <stddef.h>
#include <string.h>
#include <float.h>
#include <math.h>
#ifndef modelo_BIO_COMMON_INCLUDES_
# define modelo_BIO_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#endif                                 /* modelo_BIO_COMMON_INCLUDES_ */

#include "modelo_BIO_types.h"
#include "rtGetInf.h"
...
/* Block signals (auto storage) */
extern B_modelo_BIO_T modelo_BIO_B;

/* Continuous states (auto storage) */
extern X_modelo_BIO_T modelo_BIO_X;

/* Block states (auto storage) */
extern DW_modelo_BIO_T modelo_BIO_DW;

/* External inputs (root inport signals with auto storage) */
extern ExtU_modelo_BIO_T modelo_BIO_U;

/* External outputs (root outports fed by signals with auto storage) */
extern ExtY_modelo_BIO_T modelo_BIO_Y;

/* Constant parameters (auto storage) */
extern const ConstP_modelo_BIO_T modelo_BIO_ConstP;

/* Model entry point functions */
extern void modelo_BIO_initialize(void);
extern void modelo_BIO_step(void);
extern void modelo_BIO_terminate(void);

/* Real-time Model object */
extern RT_MODEL_modelo_BIO_T *const modelo_BIO_M;
 ...
 *
 * '<Root>' : 'modelo_BIO'
 * '<S1>'   : 'modelo_BIO/1Ph_Inverter_bio'
 * '<S2>'   : 'modelo_BIO/CSI_Control_BIO'
 * '<S3>'   : 'modelo_BIO/DC 500V'
 * '<S4>'   : 'modelo_BIO/MPC_bio'
 * '<S5>'   : 'modelo_BIO/powergui'
 * '<S6>'   : 'modelo_BIO/1Ph_Inverter_bio/Breaker'
 * '<S7>'   : 'modelo_BIO/1Ph_Inverter_bio/H bridge'
 * '<S8>'   : 'modelo_BIO/1Ph_Inverter_bio/I sens A'
 * '<S9>'   : 'modelo_BIO/1Ph_Inverter_bio/PWM Generator (DC-DC)'
 * '<S10>'  : 'modelo_BIO/1Ph_Inverter_bio/Steper1'
 * '<S11>'  : 'modelo_BIO/1Ph_Inverter_bio/Steper3'
 * '<S12>'  : 'modelo_BIO/1Ph_Inverter_bio/Vsensa1'
 * '<S13>'  : 'modelo_BIO/1Ph_Inverter_bio/not_pwm'
 * '<S14>'  : 'modelo_BIO/1Ph_Inverter_bio/Breaker/Model'
 * '<S15>'  : 'modelo_BIO/1Ph_Inverter_bio/Breaker/Model/Timer'
 * '<S16>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/ sw_ahi1'
 * '<S17>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/ sw_ahi2'
 * '<S18>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/ sw_ahi5'
 * '<S19>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/ sw_ahi6'
 * '<S20>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/Diode1'
 * '<S21>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/Diode2'
 * '<S22>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/Diode3'
 * '<S23>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/Diode6'
 * '<S24>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/ sw_ahi1/Model'
 * '<S25>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/ sw_ahi1/Model/Measurement list'
 * '<S26>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/ sw_ahi2/Model'
 * '<S27>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/ sw_ahi2/Model/Measurement list'
 * '<S28>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/ sw_ahi5/Model'
 * '<S29>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/ sw_ahi5/Model/Measurement list'
 * '<S30>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/ sw_ahi6/Model'
 * '<S31>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/ sw_ahi6/Model/Measurement list'
 * '<S32>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/Diode1/Model'
 * '<S33>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/Diode1/Model/Measurement list'
 * '<S34>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/Diode2/Model'
 * '<S35>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/Diode2/Model/Measurement list'
 * '<S36>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/Diode3/Model'
 * '<S37>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/Diode3/Model/Measurement list'
 * '<S38>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/Diode6/Model'
 * '<S39>'  : 'modelo_BIO/1Ph_Inverter_bio/H bridge/Diode6/Model/Measurement list'
 * '<S40>'  : 'modelo_BIO/1Ph_Inverter_bio/I sens A/Model'
 * '<S41>'  : 'modelo_BIO/1Ph_Inverter_bio/PWM Generator (DC-DC)/Compare To Zero'
 * '<S42>'  : 'modelo_BIO/1Ph_Inverter_bio/PWM Generator (DC-DC)/Sawtooth Generator'
 * '<S43>'  : 'modelo_BIO/1Ph_Inverter_bio/PWM Generator (DC-DC)/Sawtooth Generator/Model'
 * '<S44>'  : 'modelo_BIO/1Ph_Inverter_bio/Vsensa1/Model'
 * '<S45>'  : 'modelo_BIO/CSI_Control_BIO/Death_time'
 * '<S46>'  : 'modelo_BIO/CSI_Control_BIO/PQ2Iab_PH1'
 * '<S47>'  : 'modelo_BIO/CSI_Control_BIO/PQ_singlePhase'
 * '<S48>'  : 'modelo_BIO/CSI_Control_BIO/PR Controller_0_ref 1'
 * '<S49>'  : 'modelo_BIO/CSI_Control_BIO/PR Controller_0_ref 1/Steper6'
 * '<S50>'  : 'modelo_BIO/DC 500V/Model'
 * '<S51>'  : 'modelo_BIO/MPC_bio/MPC_MatCalc'
 * '<S52>'  : 'modelo_BIO/MPC_bio/MPC_OutLogic'
 * '<S53>'  : 'modelo_BIO/powergui/EquivalentModel1'
 * '<S54>'  : 'modelo_BIO/powergui/EquivalentModel1/Gates'
 * '<S55>'  : 'modelo_BIO/powergui/EquivalentModel1/Sources'
 * '<S56>'  : 'modelo_BIO/powergui/EquivalentModel1/Status'
 * '<S57>'  : 'modelo_BIO/powergui/EquivalentModel1/Yout'
 */
#endif                                 /* RTW_HEADER_modelo_BIO_h_ */
