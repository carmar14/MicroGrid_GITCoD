...
extern double BIO_csi_step(void);
extern void BIO_csi_terminate(void);

void set_V_bio(double);
void set_P_bio(double);
void set_Q_bio(double);
double get_V_bio(void);
double get_P_bio(void);	
double get_Q_bio(void);
