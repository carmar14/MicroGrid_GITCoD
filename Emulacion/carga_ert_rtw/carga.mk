###########################################################################
## Makefile generated for Simulink model 'carga'. 
## 
## Makefile     : carga.mk
## Generated on : Fri Jul 06 11:12:33 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/carga.exe
...
MODELREF_LINK_RSPFILE_NAME = carga_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = carga_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/carga.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/carga_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/physmod/powersys/facts/facts -I$(MATLAB_ROOT)/toolbox/physmod/powersys/DR/DR
...
DEFINES_STANDARD = -DMODEL=carga -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO
...
SRCS = $(START_DIR)/carga_ert_rtw/carga.c $(START_DIR)/carga_ert_rtw/carga_data.c $(START_DIR)/carga_ert_rtw/rtGetInf.c $(START_DIR)/carga_ert_rtw/rtGetNaN.c $(START_DIR)/carga_ert_rtw/rt_nonfinite.c

MAIN_SRC = $(START_DIR)/carga_ert_rtw/ert_main.c
...
OBJS = carga.obj carga_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
