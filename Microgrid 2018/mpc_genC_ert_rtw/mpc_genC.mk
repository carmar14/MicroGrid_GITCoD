###########################################################################
## Makefile generated for Simulink model 'mpc_genC'. 
## 
## Makefile     : mpc_genC.mk
## Generated on : Sat Apr 21 19:01:16 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mpc_genC.exe
...
MODELREF_LINK_RSPFILE_NAME = mpc_genC_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = mpc_genC_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mpc_genC.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/mpc_genC_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=mpc_genC -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/mpc_genC_ert_rtw/mpc_genC.c

MAIN_SRC = $(START_DIR)/mpc_genC_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/mpc_genC_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
