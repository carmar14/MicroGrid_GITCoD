...
extern void test1_derivatives();

//
// This function updates continuous states using the ODE3 fixed-step
// solver algorithm
//
void test1ModelClass::rt_ertODEUpdateContinuousStates(RTWSolverInfo *si )
{
  // Solver Matrices
...
void test1ModelClass::test1_derivatives()
{
  XDot *_rtXdot;
  _rtXdot = ((XDot *) (&rtM)->derivs);

  // Derivatives for TransferFcn: '<Root>/Transfer Fcn' incorporates:
  //   Derivatives for Inport: '<Root>/ref2'

  _rtXdot->TransferFcn_CSTATE = 0.0;
  _rtXdot->TransferFcn_CSTATE += -rtX.TransferFcn_CSTATE;
  _rtXdot->TransferFcn_CSTATE += rtU.ref2;
}

// Model initialize function
void test1ModelClass::initialize()
{
  // Registration code
  {
    // Setup solver object
...
// Constructor
test1ModelClass::test1ModelClass()
{
}
...
RT_MODEL * test1ModelClass::getRTM()
{
  return (&rtM);
}
