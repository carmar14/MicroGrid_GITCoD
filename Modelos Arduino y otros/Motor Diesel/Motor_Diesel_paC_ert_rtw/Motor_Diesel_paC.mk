###########################################################################
## Makefile generated for Simulink model 'Motor_Diesel_paC'. 
## 
## Makefile     : Motor_Diesel_paC.mk
## Generated on : Thu Feb 08 07:36:12 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Motor_Diesel_paC.exe
...
MODELREF_LINK_RSPFILE_NAME = Motor_Diesel_paC_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Motor_Diesel_paC_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Motor_Diesel_paC.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Motor_Diesel_paC_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Motor_Diesel_paC -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/Motor_Diesel_paC_ert_rtw/Motor_Diesel_paC.c

MAIN_SRC = $(START_DIR)/Motor_Diesel_paC_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Motor_Diesel_paC_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
