...
MODEL               = genCmotorDiesel
MODULES             = rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging.c
...
PCMATLABROOT        = D:\\Program Files\\MATLAB\\R2017a
...
MODELLIB                  = genCmotorDiesellib.lib
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/genCmotorDiesel_rsim_rtw \
...
LIBSL_IOFILE     = $(MATLAB_ROOT)\extern\lib\win64\microsoft\libmwsl_iofile.lib
...
MAT_LIBS = $(LIBUT) $(LIBMX) $(LIBMAT) $(LIBMWMATHUTIL) $(LIBSL_FILEIO) $(LIBSL_IOFILE) $(LIBSIGSTREAM) $(LIBSL_SIMTARGET_INSTRUMENTATION)
ifeq ($(RSIM_WITH_SL_SOLVER),1)
