###########################################################################
## Makefile generated for Simulink model 'codeGenTest'. 
## 
## Makefile     : codeGenTest.mk
## Generated on : Sat Apr 14 11:44:35 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/codeGenTest.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/erich/Documents/Matlab2017a/MicroGrid_GITCoD/RPiModels
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = codeGenTest_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = codeGenTest_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/codeGenTest.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/codeGenTest_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=codeGenTest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/codeGenTest_ert_rtw/codeGenTest.c

MAIN_SRC = $(START_DIR)/codeGenTest_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/codeGenTest_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
