###########################################################################
## Makefile generated for Simulink model 'BIO_csi_sf'. 
## 
## Makefile     : BIO_csi_sf.mk
## Generated on : Tue Aug 14 16:26:12 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BIO_csi_sf.exe
...
MODELREF_LINK_RSPFILE_NAME = BIO_csi_sf_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = BIO_csi_sf_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BIO_csi_sf.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/BIO_csi_sf_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=BIO_csi_sf -DNUMST=3 -DNCSTATES=9 -DHAVESTDIO
...
SRCS = $(START_DIR)/BIO_csi_sf_ert_rtw/BIO_csi_sf.c $(START_DIR)/BIO_csi_sf_ert_rtw/rtGetInf.c $(START_DIR)/BIO_csi_sf_ert_rtw/rtGetNaN.c $(START_DIR)/BIO_csi_sf_ert_rtw/rt_nonfinite.c

MAIN_SRC = $(START_DIR)/BIO_csi_sf_ert_rtw/ert_main.c
...
OBJS = BIO_csi_sf.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/BIO_csi_sf_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
