/*
 * File: code_programacion_lineal.h
 *
...
#ifndef RTW_HEADER_code_programacion_lineal_h_
#define RTW_HEADER_code_programacion_lineal_h_
#include <stddef.h>
#include <string.h>
#ifndef code_programacion_lineal_COMMON_INCLUDES_
# define code_programacion_lineal_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#endif                                 /* code_programacion_lineal_COMMON_INCLUDES_ */

#include "code_programacion_lineal_types.h"
...
typedef struct {
  ...
  real_T P2;                           /* '<Root>/P2' */
  real_T Q2;                           /* '<Root>/Q2' */
} ExtY_code_programacion_lineal_T;

/* Real-time Model Data Structure */
struct tag_RTM_code_programacion_lineal_T {
...
/* Block signals (auto storage) */
extern B_code_programacion_lineal_T code_programacion_lineal_B;

/* Block states (auto storage) */
extern DW_code_programacion_lineal_T code_programacion_lineal_DW;

/* External inputs (root inport signals with auto storage) */
extern ExtU_code_programacion_lineal_T code_programacion_lineal_U;

/* External outputs (root outports fed by signals with auto storage) */
extern ExtY_code_programacion_lineal_T code_programacion_lineal_Y;

/* Model entry point functions */
extern void code_programacion_lineal_initialize(void);
extern void code_programacion_lineal_step(void);
extern void code_programacion_lineal_terminate(void);

/* Real-time Model object */
extern RT_MODEL_code_programacion_lineal_T *const code_programacion_lineal_M;
