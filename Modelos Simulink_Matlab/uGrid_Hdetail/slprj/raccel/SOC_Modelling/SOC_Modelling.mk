...
MODEL               = SOC_Modelling
MODULES             = rt_matrx.c rt_printf.c SOC_Modelling_capi.c SOC_Modelling_data.c SOC_Modelling_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE            = SOC_Modelling.mk
...
MODELLIB                  = SOC_Modellinglib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SOC_Modelling_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/SOC_Modelling \
