...
MODEL               = uGrid_1PH_hd
MODULES             = rt_matrx.c rt_printf.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c uGrid_1PH_hd_capi.c uGrid_1PH_hd_data.c uGrid_1PH_hd_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/erich/DOCUME~1/MATLAB~1/MICROG~1/MODELO~1/UGRID_~1
S_FUNCTIONS         = rtiostream_utils.c sfun_spid_contc.c ttkernelMATLAB.cpp
...
MODELLIB                  = uGrid_1PH_hdlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = uGrid_1PH_hd_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/uGrid_1PH_hd \
...
%.obj : $(START_DIR)/truetime-2.0/kernel/%.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
...
%.obj : $(START_DIR)/truetime-2.0/kernel/%.cpp
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
