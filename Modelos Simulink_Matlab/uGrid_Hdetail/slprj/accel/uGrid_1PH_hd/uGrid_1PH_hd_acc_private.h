...
#ifndef RTW_HEADER_uGrid_1PH_hd_acc_private_h_
#define RTW_HEADER_uGrid_1PH_hd_acc_private_h_
#include "rtwtypes.h"
...
uGrid_1PH_hd_acc_rt_TDelayInterpolate ( real_T tMinusDelay , real_T tStart ,
