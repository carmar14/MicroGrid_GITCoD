...
MODEL              = uGrid_1PH_hd_caso3
MODULES            = rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c rt_zcfcn.c uGrid_1PH_hd_caso3_acc_data.c
MAKEFILE           = uGrid_1PH_hd_caso3.mk
MATLAB_ROOT        = C:/Program Files/MATLAB/R2017a
ALT_MATLAB_ROOT    = C:/PROGRA~1/MATLAB/R2017a
MASTER_ANCHOR_DIR  = 
START_DIR          = E:/PROYEC~2/UGRID_~1
...
MODELLIB                  = uGrid_1PH_hd_caso3lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/uGrid_1PH_hd_caso3 \
