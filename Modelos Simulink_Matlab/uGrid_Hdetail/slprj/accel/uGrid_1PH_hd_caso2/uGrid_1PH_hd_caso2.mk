...
MODEL              = uGrid_1PH_hd_caso2
MODULES            = rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c rt_zcfcn.c uGrid_1PH_hd_caso2_acc_data.c
MAKEFILE           = uGrid_1PH_hd_caso2.mk
...
MODELLIB                  = uGrid_1PH_hd_caso2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/uGrid_1PH_hd_caso2 \
