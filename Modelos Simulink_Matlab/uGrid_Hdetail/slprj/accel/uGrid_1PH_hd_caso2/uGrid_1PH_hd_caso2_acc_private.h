...
#ifndef RTW_HEADER_uGrid_1PH_hd_caso2_acc_private_h_
#define RTW_HEADER_uGrid_1PH_hd_caso2_acc_private_h_
#include "rtwtypes.h"
...
; real_T uGrid_1PH_hd_caso2_acc_rt_TDelayInterpolate ( real_T tMinusDelay ,
