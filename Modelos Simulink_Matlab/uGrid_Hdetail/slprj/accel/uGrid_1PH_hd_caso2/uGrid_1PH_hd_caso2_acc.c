...
#include <math.h>
#include "uGrid_1PH_hd_caso2_acc.h"
#include "uGrid_1PH_hd_caso2_acc_private.h"
#include <stdio.h>
...
#endif
boolean_T uGrid_1PH_hd_caso2_acc_rt_TDelayUpdateTailOrGrowBuf ( int_T *
...
return ( true ) ; } real_T uGrid_1PH_hd_caso2_acc_rt_TDelayInterpolate (
...
uGrid_1PH_hd_caso2_Synthesized_Atomic_Subsystem_For_Alg_Loop_1 ( SimStruct *
const S ) { ssCallAccelRunBlock ( S , 38 , 131 , SS_CALL_MDL_OUTPUTS ) ; }
void uGrid_1PH_hd_caso2_Synthesized_Atomic_Subsystem_For_Alg_Loop_1_Term (
SimStruct * const S ) { } static void mdlOutputs ( SimStruct * S , int_T tid
) { real_T B_38_361_0 ; real_T B_38_369_0 ; real_T B_38_379_0 ; real_T
B_38_387_0 ; boolean_T resetIntg ; ZCEventType zcEvent ; real_T * lastU ;
uint32_T numCycles ; real_T rtb_B_38_397_0 ; real_T rtb_RealImagtoComplex_re
; real_T rtb_RealImagtoComplex_im ; B_uGrid_1PH_hd_caso2_T * _rtB ;
P_uGrid_1PH_hd_caso2_T * _rtP ; X_uGrid_1PH_hd_caso2_T * _rtX ;
PrevZCX_uGrid_1PH_hd_caso2_T * _rtZCE ; DW_uGrid_1PH_hd_caso2_T * _rtDW ;
_rtDW = ( ( DW_uGrid_1PH_hd_caso2_T * ) ssGetRootDWork ( S ) ) ; _rtZCE = ( (
PrevZCX_uGrid_1PH_hd_caso2_T * ) _ssGetPrevZCSigState ( S ) ) ; _rtX = ( (
X_uGrid_1PH_hd_caso2_T * ) ssGetContStates ( S ) ) ; _rtP = ( (
P_uGrid_1PH_hd_caso2_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_uGrid_1PH_hd_caso2_T * ) _ssGetModelBlockIO ( S ) ) ; _rtB -> B_38_1_0 =
0.0 ; _rtB -> B_38_1_0 += _rtP -> P_144 * _rtX -> Dinmicaeneleje1_CSTATE ;
_rtB -> B_38_2_0 = _rtP -> P_145 * _rtB -> B_38_1_0 ; _rtB -> B_38_3_0 = _rtP
-> P_146 * _rtB -> B_38_2_0 ; _rtB -> B_38_4_0 = 0.0 ; _rtB -> B_38_4_0 +=
_rtP -> P_148 * _rtX -> TransferFcn_CSTATE ; _rtB -> B_38_5_0 = _rtP -> P_149
* _rtB -> B_38_4_0 ; _rtB -> B_38_6_0 = _rtB -> B_38_3_0 - _rtB -> B_38_5_0 ;
_rtB -> B_38_16_0 = 0.0 ; _rtB -> B_38_16_0 += _rtP -> P_161 * _rtX ->
Currentfilter_CSTATE ; if ( ssIsSampleHit ( S , 1 , 0 ) ) { _rtB -> B_38_14_0
= _rtDW -> itinit1_PreviousInput ; _rtB -> B_38_15_0 = _rtP -> P_159 * _rtB
-> B_38_14_0 ; if ( ssIsMajorTimeStep ( S ) ) { _rtDW -> Compare_Mode = (
_rtB -> B_38_16_0 > uGrid_1PH_hd_caso2_rtC ( S ) -> B_38_17_0 ) ; } _rtB ->
B_38_19_0 = _rtDW -> Compare_Mode ; _rtB -> B_38_20_0 = _rtDW ->
itinit_PreviousInput ; } if ( ssIsMajorTimeStep ( S ) ) { resetIntg = false ;
zcEvent = rt_ZCFcn ( RISING_ZERO_CROSSING , & _rtZCE -> inti_Reset_ZCE , (
_rtB -> B_38_19_0 ) ) ; if ( ( zcEvent != NO_ZCEVENT ) || ( _rtDW ->
inti_IWORK != 0 ) ) { resetIntg = true ; _rtX -> inti_CSTATE = _rtB ->
B_38_20_0 ; } if ( resetIntg ) { ssSetSolverNeedsReset ( S ) ; } if ( _rtX ->
inti_CSTATE >= _rtP -> P_164 ) { _rtX -> inti_CSTATE = _rtP -> P_164 ; } else
{ if ( _rtX -> inti_CSTATE <= _rtP -> P_165 ) { _rtX -> inti_CSTATE = _rtP ->
P_165 ; } } } _rtB -> B_38_21_0 = _rtX -> inti_CSTATE ; _rtB -> B_38_22_0 =
_rtP -> P_166 * _rtB -> B_38_21_0 ; if ( ssIsSampleHit ( S , 1 , 0 ) ) { if (
ssIsMajorTimeStep ( S ) ) { _rtDW -> LowerRelop1_Mode = ( _rtB -> B_38_22_0 >
_rtB -> B_38_15_0 ) ; _rtDW -> UpperRelop_Mode = ( _rtB -> B_38_22_0 < _rtB
-> B_38_24_0 ) ; } _rtB -> B_38_23_0 = _rtDW -> LowerRelop1_Mode ; _rtB ->
B_38_25_0 = _rtDW -> UpperRelop_Mode ; } if ( _rtB -> B_38_23_0 ) { _rtB ->
B_38_27_0 = _rtB -> B_38_15_0 ; } else { if ( _rtB -> B_38_25_0 ) { _rtB ->
B_13_0_0 = _rtB -> B_38_24_0 ; } else { _rtB -> B_13_0_0 = _rtB -> B_38_22_0
; } _rtB -> B_38_27_0 = _rtB -> B_13_0_0 ; } _rtB -> B_38_29_0 = 0.0 ; _rtB
-> B_38_29_0 += _rtP -> P_170 * _rtX -> StateSpace_CSTATE ; if ( _rtB ->
B_38_30_0 > _rtP -> P_174 ) { _rtB -> B_38_33_0 = muDoubleScalarExp ( ( 1.0 /
_rtB -> B_38_29_0 - 0.0034112229234180458 ) * 0.0 ) ; } else { _rtB ->
B_38_33_0 = _rtB -> B_38_31_0 ; } _rtB -> B_38_34_0 = - 0.0605295518538322 *
_rtB -> B_38_14_0 / ( _rtB -> B_38_14_0 - _rtB -> B_38_27_0 ) * _rtB ->
B_38_27_0 * _rtB -> B_38_33_0 ; _rtB -> B_38_36_0 = - _rtB -> B_38_19_0 *
...
uGrid_1PH_hd_caso2_rtC ( S ) -> B_38_45_0 ) ; } _rtB -> B_38_47_0 = _rtDW ->
...
uGrid_1PH_hd_caso2_Synthesized_Atomic_Subsystem_For_Alg_Loop_1 ( S ) ; _rtB
...
B_38_225_0 = ( real_T ) ( ( _rtB -> B_38_211_0 != uGrid_1PH_hd_caso2_rtC ( S
) -> B_38_212_0 ) && ( _rtB -> B_38_211_0 >= ( ( muDoubleScalarRem (
ssGetTaskTime ( S , 2 ) + _rtP -> P_351 , _rtP -> P_352 ) * _rtP -> P_353 *
2.0 - 1.0 ) + 1.0 ) * 0.5 ) ) * _rtP -> P_354 ; if ( ssGetTaskTime ( S , 2 )
< _rtP -> P_355 ) { rtb_B_38_397_0 = _rtP -> P_356 ; } else { rtb_B_38_397_0
= _rtP -> P_357 ; } _rtB -> B_38_227_0 = _rtB -> B_38_225_0 * rtb_B_38_397_0
; ssCallAccelRunBlock ( S , 1 , 0 , SS_CALL_MDL_OUTPUTS ) ; if (
ssGetTaskTime ( S , 2 ) < _rtP -> P_358 ) { rtb_B_38_397_0 = _rtP -> P_359 ;
} else { rtb_B_38_397_0 = _rtP -> P_360 ; } _rtB -> B_38_230_0 = _rtB ->
B_1_0_1 * rtb_B_38_397_0 ; } if ( ssIsSampleHit ( S , 1 , 0 ) ) { _rtDW ->
Step_MODE = ( ssGetTaskTime ( S , 1 ) >= _rtP -> P_362 ) ; if ( _rtDW ->
Step_MODE == 1 ) { _rtB -> B_38_232_0 = _rtP -> P_364 ; } else { _rtB ->
B_38_232_0 = _rtP -> P_363 ; } } _rtB -> B_38_234_0 = rt_Lookup ( _rtP ->
P_365 , 5 , ssGetT ( S ) , _rtP -> P_366 ) ; if ( _rtB -> B_38_231_0 >= _rtP
-> P_367 ) { _rtB -> B_38_235_0 = _rtB -> B_38_232_0 ; } else { _rtB ->
B_38_235_0 = _rtB -> B_38_234_0 ; } if ( ( _rtDW -> TimeStampA >= ssGetT ( S
) ) && ( _rtDW -> TimeStampB >= ssGetT ( S ) ) ) { _rtB -> B_38_236_0 = 0.0 ;
} else { rtb_B_38_397_0 = _rtDW -> TimeStampA ; lastU = & _rtDW ->
LastUAtTimeA ; if ( _rtDW -> TimeStampA < _rtDW -> TimeStampB ) { if ( _rtDW
-> TimeStampB < ssGetT ( S ) ) { rtb_B_38_397_0 = _rtDW -> TimeStampB ; lastU
...
- rtb_B_38_397_0 ) ; } _rtB -> B_38_247_0 = _rtP -> P_369 * _rtB ->
B_38_145_0 [ 8 ] ; _rtB -> B_38_251_0 = 0.0 ; _rtB -> B_38_251_0 += _rtP ->
P_371 * _rtX -> TransferFcn_CSTATE_g ; _rtB -> B_38_252_0 = 0.0 ; _rtB ->
B_38_252_0 += _rtP -> P_373 * _rtX -> TransferFcn1_CSTATE_p ; _rtB ->
B_38_253_0 = _rtP -> P_374 * _rtB -> B_38_145_0 [ 3 ] ; if ( ssIsSampleHit (
S , 1 , 0 ) ) { ssCallAccelRunBlock ( S , 38 , 290 , SS_CALL_MDL_OUTPUTS ) ;
_rtB -> B_38_291_0 = _rtB -> B_38_290_0 [ 0 ] + _rtB -> B_38_289_0 ; } if (
ssIsSampleHit ( S , 2 , 0 ) ) { _rtB -> B_38_305_0 = ( real_T ) ( ( _rtB ->
B_38_291_0 != uGrid_1PH_hd_caso2_rtC ( S ) -> B_38_292_0 ) && ( _rtB ->
B_38_291_0 >= ( ( muDoubleScalarRem ( ssGetTaskTime ( S , 2 ) + _rtP -> P_395
, _rtP -> P_396 ) * _rtP -> P_397 * 2.0 - 1.0 ) + 1.0 ) * 0.5 ) ) * _rtP ->
P_398 ; if ( ssGetTaskTime ( S , 2 ) < _rtP -> P_399 ) { rtb_B_38_397_0 =
_rtP -> P_400 ; } else { rtb_B_38_397_0 = _rtP -> P_401 ; } _rtB ->
B_38_307_0 = _rtB -> B_38_305_0 * rtb_B_38_397_0 ; ssCallAccelRunBlock ( S ,
3 , 0 , SS_CALL_MDL_OUTPUTS ) ; if ( ssGetTaskTime ( S , 2 ) < _rtP -> P_402
) { rtb_B_38_397_0 = _rtP -> P_403 ; } else { rtb_B_38_397_0 = _rtP -> P_404
; } _rtB -> B_38_310_0 = _rtB -> B_3_0_1 * rtb_B_38_397_0 ; } if (
ssIsSampleHit ( S , 1 , 0 ) ) { _rtDW -> Step_MODE_c = ( ssGetTaskTime ( S ,
1 ) >= _rtP -> P_406 ) ; if ( _rtDW -> Step_MODE_c == 1 ) { _rtB ->
B_38_312_0 = _rtP -> P_408 ; } else { _rtB -> B_38_312_0 = _rtP -> P_407 ; }
} _rtB -> B_38_314_0 = rt_Lookup ( _rtP -> P_409 , 5 , ssGetT ( S ) , _rtP ->
P_410 ) ; if ( _rtB -> B_38_311_0 >= _rtP -> P_411 ) { _rtB -> B_38_315_0 =
_rtB -> B_38_312_0 ; } else { _rtB -> B_38_315_0 = _rtB -> B_38_314_0 ; } if
( ( _rtDW -> TimeStampA_k >= ssGetT ( S ) ) && ( _rtDW -> TimeStampB_f >=
ssGetT ( S ) ) ) { _rtB -> B_38_316_0 = 0.0 ; } else { rtb_B_38_397_0 = _rtDW
-> TimeStampA_k ; lastU = & _rtDW -> LastUAtTimeA_m ; if ( _rtDW ->
TimeStampA_k < _rtDW -> TimeStampB_f ) { if ( _rtDW -> TimeStampB_f < ssGetT
( S ) ) { rtb_B_38_397_0 = _rtDW -> TimeStampB_f ; lastU = & _rtDW ->
LastUAtTimeB_o ; } } else { if ( _rtDW -> TimeStampA_k >= ssGetT ( S ) ) {
rtb_B_38_397_0 = _rtDW -> TimeStampB_f ; lastU = & _rtDW -> LastUAtTimeB_o ;
} } _rtB -> B_38_316_0 = ( _rtB -> B_38_314_0 - * lastU ) / ( ssGetT ( S ) -
rtb_B_38_397_0 ) ; } if ( ssIsSampleHit ( S , 1 , 0 ) ) { ssCallAccelRunBlock
( S , 38 , 327 , SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 38 , 328 ,
...
ssIsSampleHit ( S , 4 , 0 ) ) { ssCallAccelRunBlock ( S , 38 , 341 ,
...
ssIsSampleHit ( S , 4 , 0 ) ) { _rtB -> B_38_349_0 [ 0 ] = _rtB -> B_30_0_0 [
...
B_38_361_0 = uGrid_1PH_hd_caso2_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0
...
P_434 ; B_38_369_0 = uGrid_1PH_hd_caso2_acc_rt_TDelayInterpolate (
...
P_439 ; B_38_379_0 = uGrid_1PH_hd_caso2_acc_rt_TDelayInterpolate (
...
uGrid_1PH_hd_caso2_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , * tBuffer ,
...
ssIsSampleHit ( S , 3 , 0 ) ) { ssCallAccelRunBlock ( S , 38 , 426 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 38 , 427 ,
SS_CALL_MDL_OUTPUTS ) ; } if ( ssIsSampleHit ( S , 6 , 0 ) ) { rtb_B_38_397_0
= ssGetTaskTime ( S , 6 ) ; if ( ssGetTNextWasAdjusted ( S , 6 ) ) { _rtDW ->
nextTime = _ssGetVarNextHitTime ( S , 0 ) ; } if ( _rtDW -> justEnabled != 0
) { _rtDW -> justEnabled = 0 ; if ( rtb_B_38_397_0 >= _rtP -> P_478 ) {
...
-> nextTime ) ; if ( _rtDW -> currentValue == 1 ) { _rtB -> B_38_428_0 = _rtP
-> P_475 ; } else { _rtB -> B_38_428_0 = 0.0 ; } } if ( ssIsSampleHit ( S , 1
, 0 ) && ssIsMajorTimeStep ( S ) ) { zcEvent = rt_ZCFcn (
FALLING_ZERO_CROSSING , & _rtZCE -> Subsystem_Trig_ZCE_i , ( _rtB ->
B_38_428_0 ) ) ; if ( zcEvent != NO_ZCEVENT ) { ssCallAccelRunBlock ( S , 32
, 0 , SS_CALL_MDL_OUTPUTS ) ; _rtDW -> Subsystem_SubsysRanBC_eb = 4 ; } } if
( ssIsSampleHit ( S , 7 , 0 ) ) { rtb_B_38_397_0 = ssGetTaskTime ( S , 7 ) ;
...
currentValue_d == 1 ) { _rtB -> B_38_435_0 = _rtP -> P_483 ; } else { _rtB ->
B_38_435_0 = 0.0 ; } } if ( ssIsSampleHit ( S , 1 , 0 ) && ssIsMajorTimeStep
( S ) ) { zcEvent = rt_ZCFcn ( FALLING_ZERO_CROSSING , & _rtZCE ->
Subsystem_Trig_ZCE_a , ( _rtB -> B_38_435_0 ) ) ; if ( zcEvent != NO_ZCEVENT
...
currentValue_a == 1 ) { _rtB -> B_38_442_0 = _rtP -> P_491 ; } else { _rtB ->
B_38_442_0 = 0.0 ; } } if ( ssIsSampleHit ( S , 1 , 0 ) && ssIsMajorTimeStep
( S ) ) { zcEvent = rt_ZCFcn ( FALLING_ZERO_CROSSING , & _rtZCE ->
Subsystem_Trig_ZCE_d , ( _rtB -> B_38_442_0 ) ) ; if ( zcEvent != NO_ZCEVENT
) { ssCallAccelRunBlock ( S , 35 , 0 , SS_CALL_MDL_OUTPUTS ) ; _rtDW ->
Subsystem_SubsysRanBC_p = 4 ; } } _rtB -> B_38_449_0 = _rtP -> P_499 * _rtB
-> B_38_145_0 [ 7 ] ; _rtB -> B_38_453_0 = 0.0 ; _rtB -> B_38_453_0 += _rtP
-> P_501 * _rtX -> TransferFcn_CSTATE_m ; _rtB -> B_38_454_0 = 0.0 ; _rtB ->
B_38_454_0 += _rtP -> P_503 * _rtX -> TransferFcn1_CSTATE_l ; _rtB ->
B_38_455_0 = _rtP -> P_504 * _rtB -> B_38_145_0 [ 2 ] ; _rtB -> B_38_459_0 =
_rtP -> P_505 * _rtB -> B_38_145_0 [ 9 ] ; _rtB -> B_38_463_0 = 0.0 ; _rtB ->
B_38_463_0 += _rtP -> P_507 * _rtX -> TransferFcn2_CSTATE ; _rtB ->
B_38_497_0 = _rtB -> B_38_422_0 + _rtB -> B_38_496_0 ; if ( ssIsSampleHit ( S
, 2 , 0 ) ) { _rtB -> B_38_511_0 = ( real_T ) ( ( _rtB -> B_38_497_0 !=
uGrid_1PH_hd_caso2_rtC ( S ) -> B_38_498_0 ) && ( _rtB -> B_38_497_0 >= ( (
...
} else { rtb_B_38_397_0 = _rtP -> P_520 ; } _rtB -> B_38_513_0 = _rtB ->
B_38_511_0 * rtb_B_38_397_0 ; ssCallAccelRunBlock ( S , 2 , 0 ,
SS_CALL_MDL_OUTPUTS ) ; if ( ssGetTaskTime ( S , 2 ) < _rtP -> P_521 ) {
rtb_B_38_397_0 = _rtP -> P_522 ; } else { rtb_B_38_397_0 = _rtP -> P_523 ; }
_rtB -> B_38_516_0 = _rtB -> B_2_0_1 * rtb_B_38_397_0 ; } if ( ssIsSampleHit
( S , 1 , 0 ) ) { _rtDW -> Step_MODE_f = ( ssGetTaskTime ( S , 1 ) >= _rtP ->
P_525 ) ; if ( _rtDW -> Step_MODE_f == 1 ) { _rtB -> B_38_518_0 = _rtP ->
P_527 ; } else { _rtB -> B_38_518_0 = _rtP -> P_526 ; } } _rtB -> B_38_520_0
= rt_Lookup ( _rtP -> P_528 , 5 , ssGetT ( S ) , _rtP -> P_529 ) ; if ( _rtB
-> B_38_517_0 >= _rtP -> P_530 ) { _rtB -> B_38_521_0 = _rtB -> B_38_518_0 ;
} else { _rtB -> B_38_521_0 = _rtB -> B_38_520_0 ; } if ( ( _rtDW ->
TimeStampA_n >= ssGetT ( S ) ) && ( _rtDW -> TimeStampB_m >= ssGetT ( S ) ) )
{ _rtB -> B_38_522_0 = 0.0 ; } else { rtb_B_38_397_0 = _rtDW -> TimeStampA_n
...
TimeStampB_m ; lastU = & _rtDW -> LastUAtTimeB_g ; } } _rtB -> B_38_522_0 = (
_rtB -> B_38_520_0 - * lastU ) / ( ssGetT ( S ) - rtb_B_38_397_0 ) ; } _rtB
-> B_38_537_0 = ( muDoubleScalarSin ( _rtP -> P_534 * ssGetTaskTime ( S , 0 )
+ _rtP -> P_535 ) * _rtP -> P_532 + _rtP -> P_533 ) * _rtB -> B_38_407_0 ;
_rtB -> B_38_539_0 = ( muDoubleScalarSin ( _rtP -> P_538 * ssGetTaskTime ( S
, 0 ) + _rtP -> P_539 ) * _rtP -> P_536 + _rtP -> P_537 ) * _rtB ->
B_38_407_0 ; _rtB -> B_38_541_0 = ( muDoubleScalarSin ( _rtP -> P_542 *
ssGetTaskTime ( S , 0 ) + _rtP -> P_543 ) * _rtP -> P_540 + _rtP -> P_541 ) *
_rtB -> B_38_358_0 ; _rtB -> B_38_543_0 = ( muDoubleScalarSin ( _rtP -> P_546
* ssGetTaskTime ( S , 0 ) + _rtP -> P_547 ) * _rtP -> P_544 + _rtP -> P_545 )
* _rtB -> B_38_358_0 ; ssCallAccelRunBlock ( S , 38 , 544 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 38 , 545 ,
SS_CALL_MDL_OUTPUTS ) ; _rtB -> B_38_549_0 = _rtP -> P_548 * _rtB ->
B_38_145_0 [ 10 ] ; ssCallAccelRunBlock ( S , 38 , 550 , SS_CALL_MDL_OUTPUTS
) ; _rtB -> B_38_552_0 = _rtB -> B_38_81_0 - _rtP -> P_549 * _rtB ->
B_38_549_0 ; ssCallAccelRunBlock ( S , 38 , 553 , SS_CALL_MDL_OUTPUTS ) ; if
( ssIsSampleHit ( S , 1 , 0 ) ) { _rtB -> B_38_554_0 = _rtP -> P_550 * _rtB
-> B_38_14_0 ; } _rtB -> B_38_555_0 = ( 1.0 - _rtB -> B_38_27_0 / _rtB ->
B_38_554_0 ) * 100.0 ; if ( ssIsMajorTimeStep ( S ) ) { _rtDW ->
Saturation_MODE = _rtB -> B_38_555_0 >= _rtP -> P_551 ? 1 : _rtB ->
B_38_555_0 > _rtP -> P_552 ? 0 : - 1 ; } _rtB -> B_38_556_0 = _rtDW ->
Saturation_MODE == 1 ? _rtP -> P_551 : _rtDW -> Saturation_MODE == - 1 ? _rtP
-> P_552 : _rtB -> B_38_555_0 ; ssCallAccelRunBlock ( S , 38 , 557 ,
SS_CALL_MDL_OUTPUTS ) ; if ( ssIsSampleHit ( S , 11 , 0 ) ) { rtb_B_38_397_0
...
currentValue_h == 1 ) { _rtB -> B_38_558_0 = _rtP -> P_553 ; } else { _rtB ->
B_38_558_0 = 0.0 ; } } if ( ssIsSampleHit ( S , 1 , 0 ) && ssIsMajorTimeStep
( S ) ) { zcEvent = rt_ZCFcn ( FALLING_ZERO_CROSSING , & _rtZCE ->
Subsystem_Trig_ZCE , ( _rtB -> B_38_558_0 ) ) ; if ( zcEvent != NO_ZCEVENT )
{ ssCallAccelRunBlock ( S , 37 , 0 , SS_CALL_MDL_OUTPUTS ) ; _rtDW ->
Subsystem_SubsysRanBC_m = 4 ; } } if ( ssIsMajorTimeStep ( S ) ) { _rtDW ->
Abs_MODE = ( _rtB -> B_38_549_0 >= 0.0 ) ; } _rtB -> B_38_574_0 = _rtDW ->
Abs_MODE > 0 ? _rtB -> B_38_549_0 : - _rtB -> B_38_549_0 ; if ( ssIsSampleHit
( S , 1 , 0 ) ) { if ( ssIsMajorTimeStep ( S ) ) { _rtDW -> Compare_Mode_i =
( _rtB -> B_38_549_0 < uGrid_1PH_hd_caso2_rtC ( S ) -> B_38_575_0 ) ; } _rtB
-> B_38_578_0 = _rtP -> P_565 * ( real_T ) _rtDW -> Compare_Mode_i ; } _rtB
-> B_38_579_0 = _rtB -> B_38_578_0 - _rtB -> B_38_58_0 ; _rtB -> B_38_580_0 =
_rtB -> B_38_574_0 * _rtB -> B_38_579_0 ; _rtB -> B_38_581_0 = _rtP -> P_566
* _rtB -> B_38_580_0 ; _rtB -> B_38_585_0 = _rtP -> P_568 * _rtB -> B_38_27_0
; if ( ssIsMajorTimeStep ( S ) ) { _rtDW -> Abs_MODE_d = ( _rtB -> B_38_66_0
>= 0.0 ) ; } _rtB -> B_38_586_0 = _rtDW -> Abs_MODE_d > 0 ? _rtB -> B_38_66_0
: - _rtB -> B_38_66_0 ; _rtB -> B_38_587_0 = 0.05 * _rtB -> B_38_66_0 + -
_rtB -> B_38_71_0 ; if ( ssIsMajorTimeStep ( S ) ) { _rtDW -> Abs1_MODE = (
_rtB -> B_38_587_0 >= 0.0 ) ; } _rtB -> B_38_588_0 = _rtDW -> Abs1_MODE > 0 ?
_rtB -> B_38_587_0 : - _rtB -> B_38_587_0 ; if ( ssIsSampleHit ( S , 1 , 0 )
) { if ( ssIsMajorTimeStep ( S ) ) { _rtDW -> Compare_Mode_e = ( _rtB ->
B_38_66_0 < uGrid_1PH_hd_caso2_rtC ( S ) -> B_38_589_0 ) ; } _rtB ->
B_38_592_0 = _rtP -> P_570 * ( real_T ) _rtDW -> Compare_Mode_e ; } _rtB ->
B_38_594_0 = _rtB -> B_38_586_0 * _rtB -> B_38_588_0 ; _rtB -> B_38_595_0 = (
0.0 * _rtB -> B_38_586_0 * _rtB -> B_38_29_0 + _rtB -> B_38_592_0 ) + _rtB ->
B_38_594_0 ; _rtB -> B_38_598_0 = 0.0 ; _rtB -> B_38_598_0 += _rtP -> P_575 *
_rtX -> TransferFcn1_CSTATE_g ; _rtB -> B_38_599_0 = _rtP -> P_576 * _rtB ->
B_38_598_0 ; _rtB -> B_38_600_0 = _rtB -> B_38_583_0 + _rtB -> B_38_599_0 ;
...
_rtDW -> Subsystem_SubsysRanBC_l = 4 ; } } _rtB -> B_38_607_0 = _rtP -> P_577
* _rtB -> B_28_0_0 [ 1 ] ; ssCallAccelRunBlock ( S , 21 , 0 ,
SS_CALL_MDL_OUTPUTS ) ; } if ( ssIsSampleHit ( S , 5 , 0 ) ) {
ssCallAccelRunBlock ( S , 38 , 611 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 38 , 612 , SS_CALL_MDL_OUTPUTS ) ; } if (
ssIsSampleHit ( S , 1 , 0 ) ) { ssCallAccelRunBlock ( S , 38 , 613 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 38 , 614 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 20 , 0 ,
SS_CALL_MDL_OUTPUTS ) ; } if ( ssIsSampleHit ( S , 5 , 0 ) ) {
ssCallAccelRunBlock ( S , 38 , 618 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 38 , 619 , SS_CALL_MDL_OUTPUTS ) ; } if (
ssIsSampleHit ( S , 8 , 0 ) ) { rtb_B_38_397_0 = ssGetTaskTime ( S , 8 ) ; if
...
currentValue_n == 1 ) { _rtB -> B_38_620_0 = _rtP -> P_582 ; } else { _rtB ->
B_38_620_0 = 0.0 ; } } if ( ssIsSampleHit ( S , 1 , 0 ) && ssIsMajorTimeStep
( S ) ) { zcEvent = rt_ZCFcn ( FALLING_ZERO_CROSSING , & _rtZCE ->
Subsystem_Trig_ZCE_o , ( _rtB -> B_38_620_0 ) ) ; if ( zcEvent != NO_ZCEVENT
) { ssCallAccelRunBlock ( S , 34 , 0 , SS_CALL_MDL_OUTPUTS ) ; _rtDW ->
Subsystem_SubsysRanBC_b = 4 ; } } if ( ssIsSampleHit ( S , 10 , 0 ) ) {
rtb_B_38_397_0 = ssGetTaskTime ( S , 10 ) ; if ( ssGetTNextWasAdjusted ( S ,
...
currentValue_f == 1 ) { _rtB -> B_38_627_0 = _rtP -> P_590 ; } else { _rtB ->
B_38_627_0 = 0.0 ; } } if ( ssIsSampleHit ( S , 1 , 0 ) && ssIsMajorTimeStep
( S ) ) { zcEvent = rt_ZCFcn ( FALLING_ZERO_CROSSING , & _rtZCE ->
Subsystem_Trig_ZCE_f , ( _rtB -> B_38_627_0 ) ) ; if ( zcEvent != NO_ZCEVENT
) { ssCallAccelRunBlock ( S , 36 , 0 , SS_CALL_MDL_OUTPUTS ) ; _rtDW ->
Subsystem_SubsysRanBC_g = 4 ; } } if ( ssIsSampleHit ( S , 5 , 0 ) ) {
ssCallAccelRunBlock ( S , 38 , 634 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 38 , 635 , SS_CALL_MDL_OUTPUTS ) ; }
ssCallAccelRunBlock ( S , 38 , 636 , SS_CALL_MDL_OUTPUTS ) ; _rtB ->
B_38_642_0 = 0.0 ; _rtB -> B_38_642_0 += _rtP -> P_601 * _rtX ->
Actuador1_CSTATE ; _rtB -> B_38_643_0 = _rtP -> P_602 * _rtB -> B_38_642_0 ;
...
; real_T tMinusDelay = simTime - _rtP -> P_603 ; _rtB -> B_38_644_0 =
uGrid_1PH_hd_caso2_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , * tBuffer ,
...
ssIsMinorTimeStep ( S ) && ( ssGetTimeOfLastOutput ( S ) == ssGetT ( S ) ) )
) ; } _rtB -> B_38_645_0 = _rtB -> B_38_644_0 - _rtB -> B_38_640_0 ; _rtB ->
B_38_646_0 = _rtP -> P_605 * _rtB -> B_38_145_0 [ 4 ] ; _rtB -> B_38_650_0 =
_rtB -> B_38_641_0 - _rtB -> B_38_6_0 ; _rtB -> B_38_651_0 = _rtP -> P_606 *
_rtB -> B_38_650_0 ; _rtB -> B_38_652_0 = _rtX -> Filter_CSTATE ; _rtB ->
B_38_653_0 = _rtB -> B_38_651_0 - _rtB -> B_38_652_0 ; _rtB -> B_38_654_0 =
_rtP -> P_608 * _rtB -> B_38_653_0 ; _rtB -> B_38_655_0 = _rtP -> P_609 *
_rtB -> B_38_650_0 ; _rtB -> B_38_656_0 = _rtX -> Integrator_CSTATE ; _rtB ->
B_38_657_0 = _rtP -> P_611 * _rtB -> B_38_650_0 ; _rtB -> B_38_658_0 = ( _rtB
-> B_38_657_0 + _rtB -> B_38_656_0 ) + _rtB -> B_38_654_0 ; if (
ssIsSampleHit ( S , 1 , 0 ) ) { ssCallAccelRunBlock ( S , 38 , 662 ,
SS_CALL_MDL_OUTPUTS ) ; } UNUSED_PARAMETER ( tid ) ; } static void
mdlOutputsTID12 ( SimStruct * S , int_T tid ) { real_T rtb_B_38_89_0 ; real_T
rtb_B_38_127_0 ; B_uGrid_1PH_hd_caso2_T * _rtB ; P_uGrid_1PH_hd_caso2_T *
_rtP ; _rtP = ( ( P_uGrid_1PH_hd_caso2_T * ) ssGetModelRtp ( S ) ) ; _rtB = (
( B_uGrid_1PH_hd_caso2_T * ) _ssGetModelBlockIO ( S ) ) ; _rtB -> B_38_0_0 =
_rtP -> P_142 ; _rtB -> B_38_7_0 = _rtP -> P_150 ; if ( _rtP -> P_154 > _rtP
-> P_155 ) { if ( _rtP -> P_151 > _rtP -> P_152 ) { _rtB -> B_38_11_0 = _rtP
-> P_152 ; } else if ( _rtP -> P_151 < _rtP -> P_153 ) { _rtB -> B_38_11_0 =
_rtP -> P_153 ; } else { _rtB -> B_38_11_0 = _rtP -> P_151 ; } } else { _rtB
-> B_38_11_0 = _rtP -> P_151 ; } _rtB -> B_38_13_0 = _rtP -> P_157 ; _rtB ->
B_38_24_0 = _rtP -> P_167 ; _rtB -> B_38_30_0 = _rtP -> P_172 ; _rtB ->
B_38_31_0 = _rtP -> P_173 ; _rtB -> B_38_37_0 = _rtP -> P_175 ; _rtB ->
B_38_38_0 = _rtP -> P_176 ; _rtB -> B_38_48_0 = _rtP -> P_179 ; _rtB ->
B_38_49_0 = _rtP -> P_180 ; _rtB -> B_38_50_0 = _rtP -> P_181 ; _rtB ->
B_38_57_0 = _rtP -> P_182 ; if ( _rtP -> P_185 > _rtP -> P_187 ) { _rtB ->
B_38_65_0 = _rtP -> P_184 ; } else { _rtB -> B_38_65_0 = _rtP -> P_186 ; }
_rtB -> B_38_67_0 = _rtP -> P_190 ; _rtB -> B_38_68_0 = _rtP -> P_191 ; _rtB
-> B_38_72_0 = _rtP -> P_193 ; _rtB -> B_38_73_0 = _rtP -> P_194 ;
rtb_B_38_89_0 = _rtP -> P_201 + _rtP -> P_202 ; _rtB -> B_38_95_0 = _rtP ->
P_204 ; _rtB -> B_38_96_0 = ( ( rtb_B_38_89_0 - _rtP -> P_203 ) * _rtP ->
P_200 + _rtP -> P_199 ) * ( _rtP -> P_197 / _rtP -> P_198 ) * _rtB ->
B_38_95_0 ; _rtB -> B_38_97_0 = _rtP -> P_205 ; _rtB -> B_38_98_0 = _rtP ->
P_206 ; _rtB -> B_38_99_0 = _rtP -> P_207 ; _rtB -> B_38_100_0 = 0.0 / _rtB
-> B_38_99_0 ; _rtB -> B_38_105_0 = _rtP -> P_209 * rtb_B_38_89_0 / _rtP ->
P_210 * _rtP -> P_208 ; _rtB -> B_38_106_0 = _rtP -> P_211 ; rtb_B_38_127_0 =
rtb_B_38_89_0 / _rtP -> P_203 ; _rtB -> B_38_130_0 = _rtP -> P_199 / (
muDoubleScalarExp ( _rtP -> P_215 * _rtP -> P_210 / ( _rtP -> P_209 * _rtP ->
P_216 * rtb_B_38_89_0 * _rtP -> P_208 ) ) - _rtP -> P_217 ) * (
...
-> P_453 ; _rtB -> B_38_421_0 = _rtP -> P_470 ; _rtB -> B_38_430_0 = _rtP ->
P_479 ; _rtB -> B_38_431_0 = _rtP -> P_480 ; _rtB -> B_38_432_0 = _rtP ->
P_481 ; _rtB -> B_38_433_0 = _rtP -> P_482 ; _rtB -> B_38_437_0 = _rtP ->
P_487 ; _rtB -> B_38_438_0 = _rtP -> P_488 ; _rtB -> B_38_439_0 = _rtP ->
P_489 ; _rtB -> B_38_440_0 = _rtP -> P_490 ; _rtB -> B_38_444_0 = _rtP ->
P_495 ; _rtB -> B_38_445_0 = _rtP -> P_496 ; _rtB -> B_38_446_0 = _rtP ->
P_497 ; _rtB -> B_38_447_0 = _rtP -> P_498 ; _rtB -> B_38_476_0 = _rtP ->
P_508 ; _rtB -> B_38_480_0 = _rtP -> P_509 ; _rtB -> B_38_484_0 = _rtP ->
P_510 ; _rtB -> B_38_488_0 = _rtP -> P_511 ; _rtB -> B_38_496_0 = _rtP ->
P_512 ; _rtB -> B_38_517_0 = _rtP -> P_524 ; _rtB -> B_38_560_0 = _rtP ->
P_557 ; _rtB -> B_38_561_0 = _rtP -> P_558 ; _rtB -> B_38_562_0 = _rtP ->
P_559 ; _rtB -> B_38_563_0 = _rtP -> P_560 ; _rtB -> B_38_583_0 = _rtP ->
P_567 + _rtP -> P_563 ; if ( _rtP -> P_561 > _rtP -> P_573 ) { rtb_B_38_89_0
= ( _rtB -> B_38_583_0 - 293.15 ) * 0.0 + 1.0339999999999974 ; if (
rtb_B_38_89_0 > _rtP -> P_571 ) { _rtB -> B_38_597_0 = _rtP -> P_571 ; } else
if ( rtb_B_38_89_0 < _rtP -> P_572 ) { _rtB -> B_38_597_0 = _rtP -> P_572 ; }
else { _rtB -> B_38_597_0 = rtb_B_38_89_0 ; } } else { _rtB -> B_38_597_0 =
_rtP -> P_562 ; } _rtB -> B_38_608_0 [ 0 ] = _rtP -> P_578 [ 0 ] ; _rtB ->
B_38_609_0 [ 0 ] = _rtP -> P_579 [ 0 ] ; _rtB -> B_38_615_0 [ 0 ] = _rtP ->
P_580 [ 0 ] ; _rtB -> B_38_616_0 [ 0 ] = _rtP -> P_581 [ 0 ] ; _rtB ->
B_38_608_0 [ 1 ] = _rtP -> P_578 [ 1 ] ; _rtB -> B_38_609_0 [ 1 ] = _rtP ->
P_579 [ 1 ] ; _rtB -> B_38_615_0 [ 1 ] = _rtP -> P_580 [ 1 ] ; _rtB ->
B_38_616_0 [ 1 ] = _rtP -> P_581 [ 1 ] ; _rtB -> B_38_622_0 = _rtP -> P_586 ;
_rtB -> B_38_623_0 = _rtP -> P_587 ; _rtB -> B_38_624_0 = _rtP -> P_588 ;
_rtB -> B_38_625_0 = _rtP -> P_589 ; _rtB -> B_38_629_0 = _rtP -> P_594 ;
_rtB -> B_38_630_0 = _rtP -> P_595 ; _rtB -> B_38_631_0 = _rtP -> P_596 ;
_rtB -> B_38_632_0 = _rtP -> P_597 ; _rtB -> B_38_640_0 = _rtP -> P_598 ;
_rtB -> B_38_641_0 = _rtP -> P_599 ; UNUSED_PARAMETER ( tid ) ; }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { real_T * lastU ;
B_uGrid_1PH_hd_caso2_T * _rtB ; P_uGrid_1PH_hd_caso2_T * _rtP ;
X_uGrid_1PH_hd_caso2_T * _rtX ; DW_uGrid_1PH_hd_caso2_T * _rtDW ; _rtDW = ( (
DW_uGrid_1PH_hd_caso2_T * ) ssGetRootDWork ( S ) ) ; _rtX = ( (
X_uGrid_1PH_hd_caso2_T * ) ssGetContStates ( S ) ) ; _rtP = ( (
P_uGrid_1PH_hd_caso2_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_uGrid_1PH_hd_caso2_T * ) _ssGetModelBlockIO ( S ) ) ; if ( ssIsSampleHit (
S , 1 , 0 ) ) { _rtDW -> itinit1_PreviousInput = _rtB -> B_38_597_0 ; _rtDW
-> itinit_PreviousInput = _rtB -> B_38_585_0 ; } _rtDW -> inti_IWORK = 0 ; if
( _rtX -> inti_CSTATE == _rtP -> P_164 ) { switch ( _rtDW -> inti_MODE ) {
case 3 : if ( _rtB -> B_38_549_0 < 0.0 ) { ssSetSolverNeedsReset ( S ) ;
_rtDW -> inti_MODE = 1 ; } break ; case 1 : if ( _rtB -> B_38_549_0 >= 0.0 )
{ _rtDW -> inti_MODE = 3 ; ssSetSolverNeedsReset ( S ) ; } break ; default :
ssSetSolverNeedsReset ( S ) ; if ( _rtB -> B_38_549_0 < 0.0 ) { _rtDW ->
inti_MODE = 1 ; } else { _rtDW -> inti_MODE = 3 ; } break ; } } else if (
_rtX -> inti_CSTATE == _rtP -> P_165 ) { switch ( _rtDW -> inti_MODE ) { case
4 : if ( _rtB -> B_38_549_0 > 0.0 ) { ssSetSolverNeedsReset ( S ) ; _rtDW ->
inti_MODE = 2 ; } break ; case 2 : if ( _rtB -> B_38_549_0 <= 0.0 ) { _rtDW
-> inti_MODE = 4 ; ssSetSolverNeedsReset ( S ) ; } break ; default :
ssSetSolverNeedsReset ( S ) ; if ( _rtB -> B_38_549_0 > 0.0 ) { _rtDW ->
inti_MODE = 2 ; } else { _rtDW -> inti_MODE = 4 ; } break ; } } else { _rtDW
-> inti_MODE = 0 ; } ssCallAccelRunBlock ( S , 38 , 145 , SS_CALL_MDL_UPDATE
...
lastU = _rtB -> B_38_234_0 ; if ( _rtDW -> TimeStampA_k == ( rtInf ) ) {
...
( S ) ; lastU = & _rtDW -> LastUAtTimeB_o ; } * lastU = _rtB -> B_38_314_0 ;
...
uGrid_1PH_hd_caso2_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
...
if ( ! uGrid_1PH_hd_caso2_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
...
lastU = & _rtDW -> LastUAtTimeB_g ; } * lastU = _rtB -> B_38_520_0 ; { real_T
...
MotordeCombustin1_IWORK . Head ] = _rtB -> B_38_643_0 ; } UNUSED_PARAMETER (
tid ) ; }
#define MDL_UPDATE
static void mdlUpdateTID12 ( SimStruct * S , int_T tid ) { UNUSED_PARAMETER (
tid ) ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { B_uGrid_1PH_hd_caso2_T * _rtB
; P_uGrid_1PH_hd_caso2_T * _rtP ; X_uGrid_1PH_hd_caso2_T * _rtX ;
XDot_uGrid_1PH_hd_caso2_T * _rtXdot ; XDis_uGrid_1PH_hd_caso2_T * _rtXdis ;
DW_uGrid_1PH_hd_caso2_T * _rtDW ; _rtDW = ( ( DW_uGrid_1PH_hd_caso2_T * )
ssGetRootDWork ( S ) ) ; _rtXdis = ( ( XDis_uGrid_1PH_hd_caso2_T * )
ssGetContStateDisabled ( S ) ) ; _rtXdot = ( ( XDot_uGrid_1PH_hd_caso2_T * )
ssGetdX ( S ) ) ; _rtX = ( ( X_uGrid_1PH_hd_caso2_T * ) ssGetContStates ( S )
) ; _rtP = ( ( P_uGrid_1PH_hd_caso2_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_uGrid_1PH_hd_caso2_T * ) _ssGetModelBlockIO ( S ) ) ; _rtXdot ->
...
_rtB -> B_38_645_0 ; _rtXdot -> TransferFcn_CSTATE = 0.0 ; _rtXdot ->
TransferFcn_CSTATE += _rtP -> P_147 * _rtX -> TransferFcn_CSTATE ; _rtXdot ->
TransferFcn_CSTATE += _rtB -> B_38_646_0 ; _rtXdot -> Currentfilter_CSTATE =
0.0 ; _rtXdot -> Currentfilter_CSTATE += _rtP -> P_160 * _rtX ->
Currentfilter_CSTATE ; _rtXdot -> Currentfilter_CSTATE += _rtB -> B_38_549_0
; if ( ( _rtDW -> inti_MODE != 3 ) && ( _rtDW -> inti_MODE != 4 ) ) { _rtXdot
-> inti_CSTATE = _rtB -> B_38_549_0 ; _rtXdis -> inti_CSTATE = false ; } else
...
_rtB -> B_38_600_0 ; _rtXdot -> Integrator2_CSTATE = _rtB -> B_38_581_0 ;
_rtXdot -> Currentfilter1_CSTATE = 0.0 ; _rtXdot -> Currentfilter1_CSTATE +=
_rtP -> P_188 * _rtX -> Currentfilter1_CSTATE ; _rtXdot ->
Currentfilter1_CSTATE += _rtB -> B_38_549_0 ; ssCallAccelRunBlock ( S , 38 ,
...
0 ] += _rtP -> P_424 * _rtB -> B_38_453_0 ; _rtXdot -> integrator_CSTATE =
_rtB -> B_38_537_0 ; _rtXdot -> integrator_CSTATE_i = _rtB -> B_38_539_0 ;
_rtXdot -> integrator_CSTATE_p = _rtB -> B_38_541_0 ; _rtXdot ->
integrator_CSTATE_l = _rtB -> B_38_543_0 ; _rtXdot -> Hi_Pass1_CSTATE = 0.0 ;
...
; _rtXdot -> Hw5_CSTATE [ 0 ] += _rtP -> P_464 * _rtB -> B_38_463_0 ; _rtXdot
...
B_38_454_0 ; _rtXdot -> TransferFcn_CSTATE_m = 0.0 ; _rtXdot ->
TransferFcn_CSTATE_m += _rtP -> P_500 * _rtX -> TransferFcn_CSTATE_m ;
_rtXdot -> TransferFcn_CSTATE_m += _rtB -> B_38_449_0 ; _rtXdot ->
...
_rtB -> B_38_455_0 ; _rtXdot -> TransferFcn2_CSTATE = 0.0 ; _rtXdot ->
TransferFcn2_CSTATE += _rtP -> P_506 * _rtX -> TransferFcn2_CSTATE ; _rtXdot
-> TransferFcn2_CSTATE += _rtB -> B_38_459_0 ; _rtXdot ->
...
_rtB -> B_38_595_0 ; _rtXdot -> Actuador1_CSTATE = 0.0 ; _rtXdot ->
Actuador1_CSTATE += _rtP -> P_600 * _rtX -> Actuador1_CSTATE ; _rtXdot ->
Actuador1_CSTATE += _rtB -> B_38_658_0 ; _rtXdot -> Filter_CSTATE = _rtB ->
B_38_654_0 ; _rtXdot -> Integrator_CSTATE = _rtB -> B_38_655_0 ; }
#define MDL_PROJECTION
static void mdlProjection ( SimStruct * S ) { B_uGrid_1PH_hd_caso2_T * _rtB ;
P_uGrid_1PH_hd_caso2_T * _rtP ; DW_uGrid_1PH_hd_caso2_T * _rtDW ; _rtDW = ( (
DW_uGrid_1PH_hd_caso2_T * ) ssGetRootDWork ( S ) ) ; _rtP = ( (
P_uGrid_1PH_hd_caso2_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_uGrid_1PH_hd_caso2_T * ) _ssGetModelBlockIO ( S ) ) ; ssCallAccelRunBlock (
S , 38 , 145 , SS_CALL_MDL_PROJECTION ) ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { boolean_T anyStateSaturated
; B_uGrid_1PH_hd_caso2_T * _rtB ; P_uGrid_1PH_hd_caso2_T * _rtP ;
X_uGrid_1PH_hd_caso2_T * _rtX ; ZCV_uGrid_1PH_hd_caso2_T * _rtZCSV ;
DW_uGrid_1PH_hd_caso2_T * _rtDW ; _rtDW = ( ( DW_uGrid_1PH_hd_caso2_T * )
ssGetRootDWork ( S ) ) ; _rtZCSV = ( ( ZCV_uGrid_1PH_hd_caso2_T * )
ssGetSolverZcSignalVector ( S ) ) ; _rtX = ( ( X_uGrid_1PH_hd_caso2_T * )
ssGetContStates ( S ) ) ; _rtP = ( ( P_uGrid_1PH_hd_caso2_T * ) ssGetModelRtp
( S ) ) ; _rtB = ( ( B_uGrid_1PH_hd_caso2_T * ) _ssGetModelBlockIO ( S ) ) ;
_rtZCSV -> Compare_RelopInput_ZC = _rtB -> B_38_16_0 - uGrid_1PH_hd_caso2_rtC
( S ) -> B_38_17_0 ; if ( ( _rtDW -> inti_MODE == 1 ) && ( _rtX ->
inti_CSTATE >= _rtP -> P_164 ) ) { _rtZCSV -> inti_IntgUpLimit_ZC = 0.0 ; }
else { _rtZCSV -> inti_IntgUpLimit_ZC = _rtX -> inti_CSTATE - _rtP -> P_164 ;
} if ( ( _rtDW -> inti_MODE == 2 ) && ( _rtX -> inti_CSTATE <= _rtP -> P_165
...
_rtZCSV -> inti_LeaveSaturate_ZC = _rtB -> B_38_549_0 ; } else { _rtZCSV ->
...
= _rtB -> B_38_16_0 - uGrid_1PH_hd_caso2_rtC ( S ) -> B_38_45_0 ; _rtZCSV ->
...
HitCrossing_HitNoOutput_ZC_e = _rtB -> B_38_522_0 - _rtP -> P_531 ; _rtZCSV
-> Saturation_UprLim_ZC = _rtB -> B_38_555_0 - _rtP -> P_551 ; _rtZCSV ->
Saturation_LwrLim_ZC = _rtB -> B_38_555_0 - _rtP -> P_552 ; _rtZCSV ->
Abs_AbsZc_ZC = _rtB -> B_38_549_0 ; _rtZCSV -> Compare_RelopInput_ZC_f = _rtB
-> B_38_549_0 - uGrid_1PH_hd_caso2_rtC ( S ) -> B_38_575_0 ; _rtZCSV ->
Abs_AbsZc_ZC_j = _rtB -> B_38_66_0 ; _rtZCSV -> Abs1_AbsZc_ZC = _rtB ->
B_38_587_0 ; _rtZCSV -> Compare_RelopInput_ZC_b = _rtB -> B_38_66_0 -
uGrid_1PH_hd_caso2_rtC ( S ) -> B_38_589_0 ; } static void mdlInitializeSizes
( SimStruct * S ) { ssSetChecksumVal ( S , 0 , 3232989275U ) ;
ssSetChecksumVal ( S , 1 , 2149459251U ) ; ssSetChecksumVal ( S , 2 ,
3692950981U ) ; ssSetChecksumVal ( S , 3 , 2338596982U ) ; { mxArray *
...
S ) != sizeof ( DW_uGrid_1PH_hd_caso2_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal DWork sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofGlobalBlockIO ( S
) != sizeof ( B_uGrid_1PH_hd_caso2_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal BlockIO sizes do "
"not match for accelerator mex file." ) ; } { int ssSizeofParams ;
ssGetSizeofParams ( S , & ssSizeofParams ) ; if ( ssSizeofParams != sizeof (
P_uGrid_1PH_hd_caso2_T ) ) { static char msg [ 256 ] ; sprintf ( msg ,
"Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & uGrid_1PH_hd_caso2_rtDefaultP ) ; _ssSetConstBlockIO ( S , &
uGrid_1PH_hd_caso2_rtInvariant ) ; rt_InitInfAndNaN ( sizeof ( real_T ) ) ; (
( P_uGrid_1PH_hd_caso2_T * ) ssGetModelRtp ( S ) ) -> P_153 = rtMinusInf ; (
( P_uGrid_1PH_hd_caso2_T * ) ssGetModelRtp ( S ) ) -> P_165 = rtMinusInf ; }
...
ssGetCallSystemOutputFcnList ( childS ) ; callSysFcns [ 3 + 0 ] = (
SysOutputFcn ) ( NULL ) ; } slAccRegPrmChangeFcn ( S , mdlOutputsTID12 ) ; }
