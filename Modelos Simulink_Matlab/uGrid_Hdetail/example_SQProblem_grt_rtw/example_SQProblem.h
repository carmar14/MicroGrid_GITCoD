 ...
 * C source code generated on : Mon Jun 18 17:30:23 2018
 *
...
#define example_SQProblem_rtModel      RT_MODEL_example_SQProblem_T
...
typedef struct {
  ...
  struct {
    void *LoggedData[4];
  } xfvalexitflagiter_PWORK;           /* '<Root>/x, fval, exitflag, iter' */
} DW_example_SQProblem_T;

/* Backward compatible GRT Identifiers */
#define rtB                            example_SQProblem_B
#define BlockIO                        B_example_SQProblem_T
#define rtP                            example_SQProblem_P
#define Parameters                     P_example_SQProblem_T
#define rtDWork                        example_SQProblem_DW
#define D_Work                         DW_example_SQProblem_T

/* Parameters (auto storage) */
struct P_example_SQProblem_T_ {
  real_T H_Value[4];                   /* Expression: zeros(1, 4)
                                        * Referenced by: '<Root>/H'
                                        */
  real_T f_Value[2];                   /* Expression: [1 10]
                                        * Referenced by: '<Root>/f'
                                        */
  real_T A_Value[2];                   /* Expression: [1 1]
                                        * Referenced by: '<Root>/A'
                                        */
  real_T lb_Value[2];                  /* Expression: [0 0]
                                        * Referenced by: '<Root>/lb'
                                        */
  real_T ub_Value[2];                  /* Expression: [3500 3500]
                                        * Referenced by: '<Root>/ub'
                                        */
  real_T lbA_Value;                    /* Expression: [4000]
                                        * Referenced by: '<Root>/lbA'
                                        */
  real_T ubA_Value;                    /* Expression: [7000]
...
extern P_example_SQProblem_T example_SQProblem_P;
 ...
 * External functions *
 *====================*/
extern example_SQProblem_rtModel *example_SQProblem(void);
