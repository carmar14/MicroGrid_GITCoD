...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BIO_csi.exe
...
MODELREF_LINK_RSPFILE_NAME = BIO_csi_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = BIO_csi_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BIO_csi.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/BIO_csi_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/physmod/powersys/facts/facts -I$(MATLAB_ROOT)/toolbox/physmod/powersys/DR/DR
...
%.obj : $(START_DIR)/BIO_csi_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
