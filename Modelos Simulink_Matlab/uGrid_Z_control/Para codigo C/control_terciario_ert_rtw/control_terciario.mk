###########################################################################
## Makefile generated for Simulink model 'control_terciario'. 
## 
## Makefile     : control_terciario.mk
## Generated on : Wed Aug 15 11:43:07 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/control_terciario.exe
...
PRODUCT_NAME              = control_terciario
MAKEFILE                  = control_terciario.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = control_terciario_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = control_terciario_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/control_terciario.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/control_terciario_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=control_terciario -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/control_terciario_ert_rtw/control_terciario.c

MAIN_SRC = $(START_DIR)/control_terciario_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/control_terciario_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
