###########################################################################
## Makefile generated for Simulink model 'carga_sf'. 
## 
## Makefile     : carga_sf.mk
## Generated on : Wed Aug 15 11:50:02 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/carga_sf.exe
...
MODELREF_LINK_RSPFILE_NAME = carga_sf_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = carga_sf_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/carga_sf.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/carga_sf_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=carga_sf -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO
...
SRCS = $(START_DIR)/carga_sf_ert_rtw/carga_sf.c $(START_DIR)/carga_sf_ert_rtw/rtGetInf.c $(START_DIR)/carga_sf_ert_rtw/rtGetNaN.c $(START_DIR)/carga_sf_ert_rtw/rt_nonfinite.c

MAIN_SRC = $(START_DIR)/carga_sf_ert_rtw/ert_main.c
...
OBJS = carga_sf.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/carga_sf_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
