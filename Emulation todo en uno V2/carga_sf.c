...
void carga_sf_step(void)
{
  ...
  /* TransportDelay: '<S7>/Transport Delay' */
  {
    ...
    rtb_TransportDelay = rt_TDelayInterpolate2(
      tMinusDelay,
      0.0,
      *tBuffer,
      *uBuffer,
  ...
  /* TransportDelay: '<S6>/Transport Delay' */
  {
    ...
    real_T simTime = carga_sf_M->Timing.t[0];
    real_T tMinusDelay = simTime - (0.016666666666666666);
    rtb_TransportDelay_i = rt_TDelayInterpolate2(
      tMinusDelay,
      0.0,
      *tBuffer,
      *uBuffer,
  ...
  /* TransportDelay: '<S11>/Transport Delay' */
  {
    ...
    real_T simTime = carga_sf_M->Timing.t[0];
    real_T tMinusDelay = simTime - (0.016666666666666666);
    rtb_TransportDelay_h = rt_TDelayInterpolate2(
      tMinusDelay,
      0.0,
      *tBuffer,
      *uBuffer,
  ...
  /* TransportDelay: '<S10>/Transport Delay' */
  {
    ...
    real_T simTime = carga_sf_M->Timing.t[0];
    real_T tMinusDelay = simTime - (0.016666666666666666);
    rtb_TransportDelay_c = rt_TDelayInterpolate2(
      tMinusDelay,
      0.0,
      *tBuffer,
      *uBuffer,
